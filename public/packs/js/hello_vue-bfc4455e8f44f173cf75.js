...
vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"].use(vue_resource__WEBPACK_IMPORTED_MODULE_2__["default"]);
vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"].use(vue_turbolinks__WEBPACK_IMPORTED_MODULE_1__["default"]);
document.addEventListener('turbolinks:load', function () {
  vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"].http.headers.common['X-CSRF-Token'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
      ...
      methods: {
        saveUser: function saveUser() {
          this.$http.post('/users', {
            ...
            Turbolinks.visit("/users/".concat(response.body.id));
          }, function (response) {
...
/******/ });
//# sourceMappingURL=hello_vue-bfc4455e8f44f173cf75.js.map